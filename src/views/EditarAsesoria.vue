...
watchEffect(() => {
  ...
  if (foundCurso) {
    curso.value = { 
        ...
        classroom: foundCurso.classroom || '',
        clave_classroom: foundCurso.clave_classroom || '',
    }; 
  } else {
    curso.value.id = null;
...
const submitForm = async () => {
  ...
  try {
    const payload = {
        ...
        classroom: curso.value.classroom,
        clave_classroom: curso.value.clave_classroom,
    };
